...
//TODO: fix this by getting the contractor's id
        contractorID2 = getIntent().getExtras().getString("contID");
//        contractorID2 = "KHyneGAKKsOlDCSfDMJLzv8JSto2";
        Log.i("contID-:", contractorID2);
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if(estimateID != null) {
                    ...
                    String receiver_id = contractorID2.toString();
                    ...
                    mEstimates = new Estimates(sender_id, receiver_id,
                            mFirebaseServerTimeStamp, mProjectTitle, mItemAreaSpecs,
                            mDetailDescription, mOwnMaterials, mDelivery);
