            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(SearchViewDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        SearchViewDetailFragment fragment = new SearchViewDetailFragment();
                        fragment.setArguments(arguments);
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.searchview_detail_container, fragment)
                                .commit();
                    } else {
                        Context context = v.getContext();
                        Intent intent = new Intent(context, SearchViewDetailActivity.class);
                        intent.putExtra(SearchViewDetailFragment.ARG_ITEM_ID, holder.mItem.id);
