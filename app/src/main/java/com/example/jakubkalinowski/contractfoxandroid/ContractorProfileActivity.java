...
//        }
        ...
        estimateButton = (Button) findViewById(R.id.profile_estimate_button);
        messageButton = (Button) findViewById(R.id.profile_message_button);
        callButton = (LinearLayout) findViewById(R.id.call_button);
        directionsButton = (LinearLayout)findViewById(R.id.directions_button);
        websiteButton = (LinearLayout)findViewById(R.id.website_button);
        skillsButton = (LinearLayout)findViewById(R.id.skills_button);
        reviewsButton = (LinearLayout)findViewById(R.id.reviews_button);
